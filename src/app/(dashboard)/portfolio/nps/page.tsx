          ...
          {rows.length > 0 && (
            <div className="px-5 py-3 flex items-center justify-between" style={{ borderTop: '2px solid var(--wv-border)', backgroundColor: 'var(--wv-surface-2)' }}>
              ...
              <div className="flex items-center gap-6 text-xs">
                <span style={{ color: 'var(--wv-text-secondary)' }}>Contributions: <strong style={{ color: 'var(--wv-text)' }}>{formatLargeINR(summary.totalContributions)}</strong></span>
                <span style={{ color: 'var(--wv-text-secondary)' }}>Current Value: <strong style={{ color: 'var(--wv-text)' }}>{formatLargeINR(summary.totalValue)}</strong></span>
                <span style={{ color: summary.totalReturns >= 0 ? '#059669' : '#DC2626' }}>Returns: <strong>{summary.totalReturns >= 0 ? '+' : ''}{formatLargeINR(summary.totalReturns)}</strong></span>
              </div>
            </div>
          )}
        </div>
