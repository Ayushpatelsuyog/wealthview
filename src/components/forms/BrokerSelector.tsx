...
const PLATFORM_OPTIONS = [
  { label: 'MF Platform',      value: 'other' },
  { label: 'Stock Broker',     value: 'zerodha' },
  { label: 'Crypto Exchange',  value: 'other'  },
  { label: 'Bank',             value: 'other'  },
  { label: 'Insurance',        value: 'other'  },
